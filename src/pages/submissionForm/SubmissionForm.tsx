                        ...
                        {({
                            ...
                            <Form onSubmit={handleSubmit}>
                                <Form.Group className="mb-3" >
                                    <label>Project Card Image {" "} <span  onClick={() => setShowImgInfo(!showImgInfo)}><span className="iconify" data-icon="ant-design:question-circle-outlined"></span></span></label>
                                    {showImgInfo &&
                                        <ul>
                                            <li>Make sure your image is both interesting and relevant to your campaign. + </li>
                                            <li>This information is what people will see on the Kolo landing page, and they should be compelled to click on it</li>
                                        </ul>
                                    }
                                    <Form.Control 
                                        type="file" 
                                        ...
                                        ref={uploadBtnRef}
                                    />
                                    <Button className="upload-btn" onClick={addImg}>Upload Cover Photo</Button>
                                </Form.Group>
                                <Form.Group className="mb-3" >
                                ...
                                <Form.Group className="mb-3" >
                                    <Form.Label>Youtube Link {" "} <span  onClick={() => setYoutubeInfo(!youtubeInfo)}><span className="iconify" data-icon="ant-design:question-circle-outlined"></span></span></Form.Label>
                                    {youtubeInfo &&
                                        <ul>
